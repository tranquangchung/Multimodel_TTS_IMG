...
def main():
    ...
    while global_step < total_steps:
        ...
        for batch in progress_bar:
            ...
            with torch.no_grad():
                style_embeddings = t5_model.encode(prompt_instructions, convert_to_tensor=True, device=device, show_progress_bar=False) # [B, 768]
                style_embeddings = style_embeddings.clone()
