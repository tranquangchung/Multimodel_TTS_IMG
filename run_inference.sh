...
#CUDA_VISIBLE_DEVICES=1 python -W ignore generate_speech_cosy_prompt.py \
#  --config result/TTS_result/ImageSpeechGeneration_Final_Cosyvoce_Prompt/EARS_1e4_4Layer_16alpha_16rank_BS14/configs_training.yaml \
