...
CUDA_VISIBLE_DEVICES=2 python -W ignore generate_speech_cosy_prompt.py \
  --config result/TTS_result/ImageSpeechGeneration_Final_Cosyvoce_Prompt/EARSx3_Libris360_1e4_4Layer_16alpha_16rank_BS14/configs_training.yaml \
...
#  --config result/TTS_result/ImageSpeechGeneration_Final_Cosyvoce_PromptV2/EARS_1e4_4Layer_16alpha_16rank_BS14_T5/configs_training.yaml \
